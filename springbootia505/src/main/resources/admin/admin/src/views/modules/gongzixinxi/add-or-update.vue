<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="其他补助" prop="qitabuzhu">
          <el-input v-model="ruleForm.qitabuzhu" 
              placeholder="其他补助" clearable  :readonly="ro.qitabuzhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="其他补助" prop="qitabuzhu">
              <el-input v-model="ruleForm.qitabuzhu" 
                placeholder="其他补助" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    zhanghaoChange () {
      this.$http({
        url: `follow/yuangong/zhanghao?columnValue=`+ this.ruleForm.zhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
