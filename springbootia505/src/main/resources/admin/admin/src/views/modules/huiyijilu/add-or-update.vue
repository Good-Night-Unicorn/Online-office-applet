    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="参会人员" prop="canhuirenyuan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="参会人员"
                  v-model="ruleForm.canhuirenyuan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.canhuirenyuan" label="参会人员" prop="canhuirenyuan">
                    <span>{{ruleForm.canhuirenyuan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="内容记录" prop="neirongjilu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.neirongjilu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.neirongjilu" label="内容记录" prop="neirongjilu">
                    <span v-html="ruleForm.neirongjilu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.canhuirenyuan = true;
          ...
          if(o=='neirongjilu'){
            this.ruleForm.neirongjilu = obj[o];
	    this.ro.neirongjilu = true;
            continue;
          }
          if(o=='kaishishijian'){
	...
	this.ruleForm.neirongjilu = this.ruleForm.neirongjilu.replace(reg,'../../../springbootia505/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
