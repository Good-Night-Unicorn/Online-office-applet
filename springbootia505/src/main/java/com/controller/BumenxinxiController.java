...
public class BumenxinxiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		bumenxinxi.setClicknum(bumenxinxi.getClicknum()+1);
		bumenxinxi.setClicktime(new Date());
		bumenxinxiService.updateById(bumenxinxi);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,BumenxinxiEntity bumenxinxi, HttpServletRequest request,String pre){
        EntityWrapper<BumenxinxiEntity> ew = new EntityWrapper<BumenxinxiEntity>();
