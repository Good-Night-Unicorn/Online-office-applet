...
public class HuiyijiluController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		huiyijilu.setClicknum(huiyijilu.getClicknum()+1);
		huiyijilu.setClicktime(new Date());
		huiyijiluService.updateById(huiyijilu);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,HuiyijiluEntity huiyijilu, HttpServletRequest request,String pre){
        EntityWrapper<HuiyijiluEntity> ew = new EntityWrapper<HuiyijiluEntity>();
